...
- [Invoice creation idempotency](invoice-creation-idempotency.md) — explicit client request keys plus a DB unique index; never infer retries from invoice content
