  ...
  'Northeast': {
    ...
    monthlyTasks: {
      ...
      10: { // October
        ...
        weatherSpecific: [
          { title: 'Prepare heating system for cold weather', description: 'Have professional service furnace/boiler now. Replace filters and stock extras. Clean registers and ensure none are blocked. Test thermostat operation. Bleed hot water radiators if applicable. Check for unusual sounds when system runs. Prepare before first freeze.' },
      ...
      11: { // November
        seasonal: [
          ...
          { title: 'Test heating system thoroughly', description: 'Run heating system for several hours to ensure it maintains comfortable temperature. Listen for unusual noises. Check all rooms heat evenly. Replace filters. Verify thermostat accuracy with separate thermometer. Schedule immediate service if any issues arise before winter cold.' },
        ...
        weatherSpecific: [
          { title: 'Ensure heating system is operating efficiently', description: 'Monitor heating system performance as temperatures drop. Check that home heats evenly without cold spots. Listen for unusual noises. Replace filters monthly during heating season. Watch energy bills for unexpected increases. Address any issues immediately before system fails in extreme cold.' },
