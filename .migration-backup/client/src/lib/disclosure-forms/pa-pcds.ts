...
export const PA_PCDS_SECTIONS: DisclosureSection[] = [
  {
    id: "general",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "undergroundTank", questionNumber: 9, text: "Is there a buried oil or chemical storage tank on the property?", type: "yes_no_unknown", followUp: "If yes, describe type and current status." },
      { id: "mineSubsidence", questionNumber: 10, text: "Is the property located in an area subject to underground mine subsidence?", type: "yes_no_unknown", followUp: "If yes, is mine subsidence insurance in effect?" },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "roofLeaks", questionNumber: 16, text: "Do you know of any roof leaks or damage?", type: "yes_no_unknown", followUp: "If yes, describe and whether repaired." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "plumbingType", questionNumber: 22, text: "Primary plumbing material", type: "select", options: ["Copper", "PEX", "PVC", "Galvanized Steel", "Cast Iron", "Lead", "Other / Unknown"], prefillKey: "plumbingType", hint: "From your home profile" },
  ...
  },
  {
    ...
    description: "Legal matters and Pennsylvania-specific disclosures.",
    questions: [
      ...
      { id: "certificateOfOccupancy", questionNumber: 31, text: "Is there a valid Certificate of Occupancy for the property?", type: "yes_no_unknown" },
...
export function generatePASummaryText(answers: DisclosureAnswers, propertyAddress?: string): string {
  const lines: string[] = [];
  lines.push("PENNSYLVANIA SELLER'S PROPERTY DISCLOSURE STATEMENT");
  lines.push("=".repeat(55));
  if (propertyAddress) lines.push(`Property Address: ${propertyAddress}`);
  lines.push("");
  for (const section of PA_PCDS_SECTIONS) {
