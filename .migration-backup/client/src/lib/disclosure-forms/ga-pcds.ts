...
export const GA_PCDS_SECTIONS: DisclosureSection[] = [
  {
    id: "general",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "mold", questionNumber: 7, text: "Do you know of any mold or water damage?", type: "yes_no_unknown", followUp: "If yes, describe and whether treated." },
      { id: "undergroundTank", questionNumber: 8, text: "Is there a buried oil or chemical storage tank?", type: "yes_no_unknown", followUp: "If yes, describe type and EPD status." },
      { id: "floodZone", questionNumber: 9, text: "Is the property in a FEMA Special Flood Hazard Area?", type: "yes_no_unknown" },
    ],
  },
  {
    id: "structural",
    ...
    questions: [
      { id: "foundationType", questionNumber: 10, text: "Type of foundation", type: "select", options: ["Basement", "Crawl Space", "Slab", "Pier & Beam", "Other / Unknown"], prefillKey: "foundationType", hint: "From your home profile" },
      { id: "foundationProblems", questionNumber: 11, text: "Do you know of any foundation defects, settling, or cracking?", type: "yes_no_unknown", followUp: "If yes, describe." },
      { id: "roofType", questionNumber: 12, text: "Roof material type", type: "select", options: ["Asphalt Shingles", "Metal", "Tile", "Slate", "Wood Shakes", "Flat / Built-up", "Other / Unknown"], prefillKey: "roofType", hint: "From your home profile" },
      { id: "roofAge", questionNumber: 13, text: "Approximate year current roof was installed", type: "number", prefillKey: "roofInstalledYear", hint: "From your home profile" },
      { id: "roofLeaks", questionNumber: 14, text: "Do you know of any roof leaks or damage?", type: "yes_no_unknown", followUp: "If yes, describe." },
      { id: "basementWater", questionNumber: 15, text: "Do you know of any water intrusion or dampness?", type: "yes_no_unknown", followUp: "If yes, describe." },
      { id: "termiteWDO", questionNumber: 16, text: "Do you know of any wood-destroying insect infestation or damage?", type: "yes_no_unknown", followUp: "If yes, describe treatment and repairs." },
    ],
  },
  {
    id: "mechanical",
    ...
    questions: [
      { id: "heatingType", questionNumber: 17, text: "Primary heating system type", type: "select", options: ["Forced Air Furnace", "Heat Pump", "Boiler / Radiator", "Electric Baseboard", "Radiant Floor", "Other / Unknown"], prefillKey: "hvacType", hint: "From your home profile" },
      { id: "heatingFuel", questionNumber: 18, text: "Primary heating fuel", type: "select", options: ["Natural Gas", "Oil", "Electric", "Propane", "Other / Unknown"], prefillKey: "primaryHeatingFuel", hint: "From your home profile" },
      ...
      { id: "heatingDefects", questionNumber: 20, text: "Do you know of any defects in the HVAC system?", type: "yes_no_unknown", followUp: "If yes, describe." },
  ...
  },
  {
    ...
    description: "Legal matters and Georgia-specific disclosures.",
    questions: [
      ...
      { id: "propertyLineDisputes", questionNumber: 31, text: "Are there any property line or boundary disputes?", type: "yes_no_unknown", followUp: "If yes, describe." },
      ...
      { id: "otherDefects", questionNumber: 34, text: "Are you aware of any other material defects not previously disclosed?", type: "yes_no_unknown", followUp: "If yes, describe." },
    ],
  },
];

export function generateGASummaryText(answers: DisclosureAnswers, propertyAddress?: string): string {
  const lines: string[] = [];
  lines.push("GEORGIA SELLER'S PROPERTY DISCLOSURE STATEMENT");
  lines.push("=".repeat(55));
  if (propertyAddress) lines.push(`Property Address: ${propertyAddress}`);
  lines.push("");
  for (const section of GA_PCDS_SECTIONS) {
