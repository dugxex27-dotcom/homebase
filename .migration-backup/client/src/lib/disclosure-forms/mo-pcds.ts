...
export const MO_PCDS_SECTIONS: DisclosureSection[] = [
  {
    id: "general",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "undergroundTank", questionNumber: 9, text: "Is there a buried oil or chemical storage tank?", type: "yes_no_unknown", followUp: "If yes, describe type and MDNR status." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "basementWater", questionNumber: 17, text: "Do you know of any water intrusion or dampness?", type: "yes_no_unknown", followUp: "If yes, describe." },
    ],
  },
  {
    id: "mechanical",
  ...
  },
  {
    ...
    description: "Legal matters and Missouri-specific disclosures.",
    questions: [
...
export function generateMOSummaryText(answers: DisclosureAnswers, propertyAddress?: string): string {
  const lines: string[] = [];
  lines.push("MISSOURI SELLER'S DISCLOSURE STATEMENT");
  lines.push("=".repeat(55));
  if (propertyAddress) lines.push(`Property Address: ${propertyAddress}`);
  lines.push("");
  for (const section of MO_PCDS_SECTIONS) {
