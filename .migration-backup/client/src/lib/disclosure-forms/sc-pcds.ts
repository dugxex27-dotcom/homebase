...
export const SC_PCDS_SECTIONS: DisclosureSection[] = [
  {
    id: "general",
    ...
    questions: [
      ...
      { id: "hoaAssessments", questionNumber: 5, text: "Are there any current or pending special assessments?", type: "yes_no_unknown", followUp: "If yes, describe." },
    ],
  },
  {
    id: "environmental",
    ...
    questions: [
      ...
      { id: "undergroundTank", questionNumber: 9, text: "Is there a buried oil or chemical storage tank?", type: "yes_no_unknown", followUp: "If yes, describe type and DHEC status." },
      { id: "floodZone", questionNumber: 10, text: "Is the property in a FEMA Special Flood Hazard Area?", type: "yes_no_unknown" },
      { id: "floodInsurance", questionNumber: 11, text: "Is flood insurance currently maintained or required?", type: "yes_no_unknown" },
    ],
  },
  {
    id: "structural",
    ...
    questions: [
      { id: "foundationType", questionNumber: 12, text: "Type of foundation", type: "select", options: ["Crawl Space", "Slab", "Basement", "Pier & Beam", "Other / Unknown"], prefillKey: "foundationType", hint: "From your home profile" },
      ...
      { id: "basementWater", questionNumber: 17, text: "Do you know of any water intrusion or dampness in a crawl space or basement?", type: "yes_no_unknown", followUp: "If yes, describe." },
      { id: "termiteWDO", questionNumber: 18, text: "Do you know of any wood-destroying insect infestation or damage?", type: "yes_no_unknown", followUp: "If yes, describe treatment and repairs." },
    ],
  },
  {
    id: "mechanical",
    ...
    questions: [
      { id: "heatingType", questionNumber: 19, text: "Primary heating system type", type: "select", options: ["Heat Pump", "Forced Air Furnace", "Electric Baseboard", "Other / Unknown"], prefillKey: "hvacType", hint: "From your home profile" },
      { id: "heatingFuel", questionNumber: 20, text: "Primary heating fuel", type: "select", options: ["Natural Gas", "Oil", "Electric", "Propane", "Other / Unknown"], prefillKey: "primaryHeatingFuel", hint: "From your home profile" },
  ...
  },
  {
    ...
    description: "Legal matters and South Carolina-specific disclosures.",
    questions: [
...
export function generateSCSummaryText(answers: DisclosureAnswers, propertyAddress?: string): string {
  const lines: string[] = [];
  lines.push("SOUTH CAROLINA RESIDENTIAL PROPERTY CONDITION DISCLOSURE STATEMENT");
  lines.push("=".repeat(55));
  if (propertyAddress) lines.push(`Property Address: ${propertyAddress}`);
  lines.push("");
  for (const section of SC_PCDS_SECTIONS) {
