...
export const OR_PCDS_SECTIONS: DisclosureSection[] = [
  {
    id: "general",
    ...
    questions: [
      ...
      { id: "zoningCompliance", questionNumber: 5, text: "Is the property compliant with applicable zoning laws?", type: "yes_no_unknown", followUp: "If no, describe the non-compliance." },
    ],
  },
  {
    id: "environmental",
    title: "Environmental Conditions",
    description: "Hazardous materials and Oregon environmental concerns.",
    questions: [
      ...
      { id: "undergroundTank", questionNumber: 9, text: "Is there a buried oil or chemical storage tank?", type: "yes_no_unknown", followUp: "If yes, describe type and DEQ status." },
      { id: "floodZone", questionNumber: 10, text: "Is the property in a FEMA Special Flood Hazard Area?", type: "yes_no_unknown" },
      { id: "landslideRisk", questionNumber: 11, text: "Is the property in an area with known landslide or slope instability risk?", type: "yes_no_unknown" },
      { id: "wildfire", questionNumber: 12, text: "Is the property in a high wildfire risk area per Oregon Department of Forestry?", type: "yes_no_unknown" },
    ],
  },
  {
    id: "structural",
    ...
    questions: [
      ...
      { id: "roofType", questionNumber: 15, text: "Roof material type", type: "select", options: ["Asphalt Shingles", "Metal", "Tile", "Slate", "Cedar Shake", "Flat / Built-up", "Other / Unknown"], prefillKey: "roofType", hint: "From your home profile" },
      ...
      { id: "basementWater", questionNumber: 18, text: "Do you know of any water intrusion or dampness?", type: "yes_no_unknown", followUp: "If yes, describe." },
    ],
  },
  {
    id: "mechanical",
    ...
    questions: [
      { id: "heatingType", questionNumber: 19, text: "Primary heating system type", type: "select", options: ["Forced Air Furnace", "Heat Pump", "Boiler / Radiator", "Electric Baseboard", "Radiant Floor", "Ductless Mini-Split", "Other / Unknown"], prefillKey: "hvacType", hint: "From your home profile" },
  ...
  },
  {
    ...
    description: "Legal matters and Oregon-specific disclosures.",
    questions: [
      ...
      { id: "smokeDetectors", questionNumber: 34, text: "Are smoke detectors installed per Oregon law?", type: "yes_no_unknown" },
      { id: "carbonMonoxide", questionNumber: 35, text: "Are carbon monoxide detectors installed per Oregon law?", type: "yes_no_unknown" },
...
export function generateORSummaryText(answers: DisclosureAnswers, propertyAddress?: string): string {
  const lines: string[] = [];
  lines.push("OREGON SELLER'S PROPERTY DISCLOSURE STATEMENT");
  lines.push("=".repeat(55));
  if (propertyAddress) lines.push(`Property Address: ${propertyAddress}`);
  lines.push("");
  for (const section of OR_PCDS_SECTIONS) {
