...
CREATE UNIQUE INDEX IF NOT EXISTS "UX_wfr_user_house_trigger" ON "weather_forecast_reminders_sent" USING btree ("user_id","house_id","trigger_type","sent_at");--> statement-breakpoint
