              ...
              <form onSubmit={registerForm.handleSubmit((d) => registerMutation.mutate(d))} data-testid="form-register-agent">
                ...
                {referralCodeValue && (
                  <FormField control={registerForm.control} name="referralCode" render={({ field }) => (
                    <FormItem style={{ marginBottom: 10 }}><label style={labelStyle}>Referral code</label><FormControl><Input {...field} readOnly data-testid="input-referral-code-agent" style={{ ...inpStyle, opacity: 0.7 }} className="focus-visible:ring-0 focus-visible:ring-offset-0" /></FormControl><FormMessage /></FormItem>
                  )} />
                )}
