...
const ROLES: Record<RoleKey, {
  ...
  agent: {
    ...
    faqs: [
      ...
      { q: "What do agents receive?", a: "Agents get free forever access and can share a thoughtful closing gift, co-branded reports, and listing-prep tools with clients." },
      ...
      { q: "How does the RE Agent referral program work?", a: "Sign up as a Real Estate Agent to get a unique referral code and shareable QR code. Share it with homeowners you work with so they can receive a free forever home record. Use co-branded reports for listing prep and stay connected through every chapter." },
      { q: "What does the agent program cost?", a: "Creating a Real Estate Agent account is free forever. There is no agent subscription—just useful closing gifts and relationship tools." },
    ],
    contactCategories: [
      { value: 'general', label: 'General Inquiry' },
