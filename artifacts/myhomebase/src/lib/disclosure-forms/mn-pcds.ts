...
export const MN_PCDS_SECTIONS: DisclosureSection[] = [
  {
    id: "general",
  ...
  },
  {
    ...
    description: "Hazardous materials and Minnesota environmental concerns.",
    questions: [
      ...
      { id: "radon", questionNumber: 7, text: "Has radon been tested for? Minnesota has elevated radon levels.", type: "yes_no_unknown", followUp: "If yes, were mitigation steps taken?" },
      ...
      { id: "undergroundTank", questionNumber: 9, text: "Is there a buried oil or chemical storage tank?", type: "yes_no_unknown", followUp: "If yes, describe type and MPCA status." },
      { id: "methLab", questionNumber: 10, text: "Do you know if the property was ever used as a methamphetamine lab?", type: "yes_no_unknown", followUp: "If yes, was decontamination performed?" },
  ...
  },
  {
    ...
    description: "Legal matters and Minnesota-specific disclosures.",
    questions: [
      ...
      { id: "smokeDetectors", questionNumber: 33, text: "Are smoke detectors installed per Minnesota law?", type: "yes_no_unknown" },
      { id: "carbonMonoxide", questionNumber: 34, text: "Are carbon monoxide detectors installed per Minnesota law?", type: "yes_no_unknown" },
...
export function generateMNSummaryText(answers: DisclosureAnswers, propertyAddress?: string): string {
  const lines: string[] = [];
  lines.push("MINNESOTA SELLER'S PROPERTY DISCLOSURE STATEMENT");
  lines.push("=".repeat(55));
  if (propertyAddress) lines.push(`Property Address: ${propertyAddress}`);
  lines.push("");
  for (const section of MN_PCDS_SECTIONS) {
