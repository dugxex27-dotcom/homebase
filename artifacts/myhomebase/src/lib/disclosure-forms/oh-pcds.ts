...
export const OH_PCDS_SECTIONS: DisclosureSection[] = [
  {
    id: "general",
    ...
    questions: [
      ...
      { id: "hoaExists", questionNumber: 4, text: "Is there a homeowners association or condominium association?", type: "yes_no", followUp: "If yes, provide name and dues." },
    ],
  },
  {
    id: "environmental",
    ...
    questions: [
      ...
      { id: "undergroundTank", questionNumber: 9, text: "Is there a buried oil or chemical storage tank?", type: "yes_no_unknown", followUp: "If yes, describe type and current status." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "foundationProblems", questionNumber: 12, text: "Do you know of any foundation defects, settling, or movement?", type: "yes_no_unknown", followUp: "If yes, describe." },
  ...
  },
  {
    ...
    description: "Legal matters and Ohio-specific disclosures.",
    questions: [
...
export function generateOHSummaryText(answers: DisclosureAnswers, propertyAddress?: string): string {
  const lines: string[] = [];
  lines.push("OHIO RESIDENTIAL PROPERTY DISCLOSURE FORM");
  lines.push("=".repeat(55));
  if (propertyAddress) lines.push(`Property Address: ${propertyAddress}`);
  lines.push("");
  for (const section of OH_PCDS_SECTIONS) {
