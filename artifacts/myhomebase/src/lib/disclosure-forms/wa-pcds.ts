...
export const WA_PCDS_SECTIONS: DisclosureSection[] = [
  {
    id: "general",
    ...
    questions: [
      ...
      { id: "zoningCompliance", questionNumber: 5, text: "Is the property currently in compliance with all applicable zoning ordinances?", type: "yes_no_unknown", followUp: "If no, describe the non-compliance." },
      { id: "criticalAreas", questionNumber: 6, text: "Is the property located in or adjacent to a designated critical area (wetlands, slopes, shoreline)?", type: "yes_no_unknown", followUp: "If yes, describe." },
    ],
  },
  {
    id: "environmental",
    title: "Environmental Conditions",
    description: "Hazardous materials and Washington environmental disclosures.",
    questions: [
      ...
      { id: "undergroundTank", questionNumber: 10, text: "Is there a buried oil or chemical storage tank?", type: "yes_no_unknown", followUp: "If yes, describe type, age, and Ecology Department status." },
      { id: "hazardousMaterials", questionNumber: 11, text: "Do you know of any other hazardous materials or contamination on the property?", type: "yes_no_unknown", followUp: "If yes, describe." },
      { id: "floodZone", questionNumber: 12, text: "Is the property in a FEMA Special Flood Hazard Area?", type: "yes_no_unknown" },
      { id: "seismicHazard", questionNumber: 13, text: "Is the property in a seismic hazard area (liquefaction or landslide susceptibility)?", type: "yes_no_unknown" },
    ],
  },
  {
    id: "structural",
    ...
    questions: [
      ...
      { id: "roofType", questionNumber: 16, text: "Roof material type", type: "select", options: ["Asphalt Shingles", "Metal", "Tile", "Cedar Shake", "Flat / Built-up", "Other / Unknown"], prefillKey: "roofType", hint: "From your home profile" },
      { id: "roofAge", questionNumber: 17, text: "Approximate year current roof was installed", type: "number", prefillKey: "roofInstalledYear", hint: "From your home profile" },
      { id: "roofLeaks", questionNumber: 18, text: "Do you know of any roof leaks or damage?", type: "yes_no_unknown", followUp: "If yes, describe." },
      { id: "basementWater", questionNumber: 19, text: "Do you know of any water intrusion or dampness in a basement or crawl space?", type: "yes_no_unknown", followUp: "If yes, describe." },
    ],
  },
  {
    id: "mechanical",
    ...
    questions: [
      { id: "heatingType", questionNumber: 20, text: "Primary heating system type", type: "select", options: ["Forced Air Furnace", "Heat Pump", "Electric Baseboard", "Radiant Floor", "Ductless Mini-Split", "Other / Unknown"], prefillKey: "hvacType", hint: "From your home profile" },
      ...
      { id: "heatingDefects", questionNumber: 23, text: "Do you know of any defects in the heating or cooling system?", type: "yes_no_unknown", followUp: "If yes, describe." },
      ...
      { id: "electricalDefects", questionNumber: 28, text: "Do you know of any electrical defects?", type: "yes_no_unknown", followUp: "If yes, describe." },
  ...
  },
  {
    ...
    description: "Legal matters and Washington-specific disclosures.",
    questions: [
      ...
      { id: "smokeDetectors", questionNumber: 35, text: "Are smoke detectors installed per Washington law?", type: "yes_no_unknown" },
      { id: "carbonMonoxide", questionNumber: 36, text: "Are carbon monoxide detectors installed per Washington law?", type: "yes_no_unknown" },
...
export function generateWASummaryText(answers: DisclosureAnswers, propertyAddress?: string): string {
  const lines: string[] = [];
  lines.push("WASHINGTON STATE SELLER DISCLOSURE STATEMENT");
  lines.push("=".repeat(55));
  if (propertyAddress) lines.push(`Property Address: ${propertyAddress}`);
  lines.push("");
  for (const section of WA_PCDS_SECTIONS) {
