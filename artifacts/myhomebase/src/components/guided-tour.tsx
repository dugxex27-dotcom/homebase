...
const AGENT_STEPS: StepDef[] = [
  {
    ...
    body: "See your total referrals and active client relationships in real time. Every closing you do can become a lasting connection.",
    icon: TrendingUp,
    preferBelow: true,
  },
  {
    ...
    page: "/agent-dashboard",
    title: "Client Relationship Program",
    body: "Share a free forever home record as a closing gift. Clients can use it for maintenance, listing prep, and every future move.",
    icon: Star,
    preferBelow: true,
  },
  {
  ...
  },
  {
    ...
    body: "See every client you've referred and their subscription status so you can keep supporting them before and after closing.",
    icon: Users,
    preferBelow: false,
  },
];
