...
import whiteLogoIcon from '@assets/my-homebase-logo-tm-final-white_1777417516350.png';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 sm:gap-8">
          ...
          {typedUser?.role === 'homeowner' && (
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-2 sm:space-y-3 text-gray-300 text-sm sm:text-base">
                ...
                <li><a href="/info" className="hover:text-white transition-colors" data-testid="link-myhomebase-info-footer">MyHomeBase™ Info</a></li>
              </ul>
            </div>
          )}
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-2 sm:space-y-3 text-gray-300 text-sm sm:text-base">
              ...
              <li><Link href="/support?tab=contact" className="transition-colors hover:text-white" data-testid="link-contact-us">Contact Us</Link></li>
            </ul>
          </div>
