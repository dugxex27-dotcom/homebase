...
const AddHome = lazy(() => import("./pages/add-home"));
...
const ContractorCheckout = lazy(() => import("./pages/contractor-checkout"));
const ContractorCalendar = lazy(() => import("./pages/contractor-calendar"));
...
const AdminMaintenanceEvidenceReviews = lazy(() => import("./pages/admin-maintenance-evidence-reviews"));
  ...
  return (
    <AuthenticatedLayout>
      ...
      <Switch>
        ...
        <Route path="/qa/admin" component={QaAdminConsole} />
