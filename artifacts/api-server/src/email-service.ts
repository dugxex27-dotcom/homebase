...
export async function sendWelcomeEmail(userId: string, userName: string, userRole: string): Promise<boolean> {
  ...
  const html = wrapEmailContent(
    ...
    `
      ...
      ${roleSpecificContent}
      <p>Complete your plan setup to activate your <strong>14-day free trial</strong>. Your card will be required at checkout but <strong>not charged for 14 days</strong> — cancel anytime before then and you owe nothing.</p>
  ...
  const text = `Welcome to HomeBase, ${userName || 'there'}! Thanks for joining - think of us as CARFAX for your home. Complete your plan setup to start your 14-day free trial — your card won't be charged for 14 days. Visit gotohomebase.com to get started. Questions? Email us at gotohomebase2025@gmail.com.`;
