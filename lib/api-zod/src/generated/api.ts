...
export const RunInvoiceOrphanCleanupResponse = zod.object({
  "scanned": zod.number().describe('Total number of files inspected in object storage'),
  "deleted": zod.number().describe('Number of orphaned files deleted'),
  "skipped": zod.number().describe('Number of files skipped (referenced or within grace period)'),
