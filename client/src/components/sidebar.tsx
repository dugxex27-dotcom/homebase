      ...
      <nav className="flex-1 p-3 space-y-0.5" aria-label="Main navigation">
        ...
        {isHomeowner && (
          <>
            ...
            <Link href="/documents"><button className={nav(['/documents', '/disclosures'])} style={navStyle(['/documents', '/disclosures'])} data-testid="nav-documents"><FolderOpen className="w-4 h-4 flex-shrink-0" />Documents</button></Link>
