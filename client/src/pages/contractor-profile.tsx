    ...
    <div className="min-h-screen" style={{ background: '#f8fafc' }}>
      ...
      <div className="mt-8">
        ...
        <p className="mb-4" style={{ color: 'white' }}>
          Connect your bank account to receive payments directly from customers through MyHomeBase™ invoices.
        </p>
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  This will permanently cancel your MyHomeBase™ contractor account. Your subscription will be cancelled and you will lose access to:
