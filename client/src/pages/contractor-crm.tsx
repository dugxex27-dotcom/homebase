            ...
            <Dialog open={isAddIntegrationOpen} onOpenChange={setIsAddIntegrationOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>Connect your external CRM platform to automatically sync leads to My HomeBase</DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  <div>
          ...
          {isLoadingIntegrations ? (
            ...
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground mb-4">Connect your CRM platform to automatically sync leads to My HomeBase</p>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <p className="text-sm text-muted-foreground">
                        When customers pay invoices through My HomeBase, payments go directly to your connected Stripe account.
                      </p>
                      <div className="p-4 rounded-lg bg-green-50 border border-green-100">
                        <p className="text-sm text-green-700 font-medium">No My HomeBase fees on payments!</p>
