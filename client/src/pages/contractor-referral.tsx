...
import instagramStoryImg from '@assets/generated_images/homebase_contractor_instagram_story_template.png';
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <Button
                      onClick={() => downloadImageWithCode(instagramStoryImg, `homebase-contractor-story-${referralCode}.png`, { x: 540, y: 1800 }, '#ffffff', 48, 'center')}
                      size="sm"
                      className="w-full bg-blue-600 hover:bg-blue-700 text-white"
