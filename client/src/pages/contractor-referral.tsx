...
import homeownerInstagramPostImg from '@assets/ChatGPT_Image_Dec_26,_2025,_01_40_38_PM_1766774453605.png';
...
export default function ContractorReferral() {
  ...
  const downloadImageWithCode = async (imageSrc: string, filename: string, codePosition: { x: number, y: number }, textColor: string = '#1560a2', fontSize: number = 48, textAlign: CanvasTextAlign = 'center') => {
    try {
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                    ...
                    <div className="space-y-1">
                      ...
                      <Button
                        onClick={() => downloadImageWithCode(instagramStoryImg, `homebase-contractor-story-${referralCode}.png`, { x: 300, y: 730 }, '#1e3a5f', 48, 'center')}
                        size="sm"
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-gray-500">Square format - 1080x1080px</p>
                      <Button
                        onClick={() => downloadImageWithCode(homeownerInstagramPostImg, `homebase-homeowner-post-${referralCode}.png`, { x: 72, y: 926 }, '#1e3a5f', 40, 'left')}
                        size="sm"
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white"
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-gray-500">Vertical format - 1080x1920px</p>
                      <Button
                        onClick={() => downloadImageWithCode(homeownerInstagramStoryImg, `homebase-homeowner-story-${referralCode}.png`, { x: 396, y: 1210 }, '#1e3a5f', 48, 'center')}
                        size="sm"
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white"
