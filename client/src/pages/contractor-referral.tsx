              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <Button
                      onClick={() => downloadImageWithCode(instagramPostImg, `homebase-contractor-instagram-${referralCode}.png`, { x: 540, y: 902 }, '#ffffff', 48, 'center')}
                      size="sm"
                ...
                <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <Button
                      onClick={() => downloadImageWithCode(instagramStoryImg, `homebase-contractor-story-${referralCode}.png`, { x: 636, y: 1354 }, '#ffffff', 48, 'center')}
                      size="sm"
                      className="w-full bg-blue-600 hover:bg-blue-700 text-white"
                ...
                <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <Button
                      onClick={() => downloadImageWithCode(facebookTwitterImg, `homebase-contractor-facebook-${referralCode}.png`, { x: 712, y: 798 }, '#ffffff', 32, 'left')}
                      size="sm"
                      className="w-full bg-blue-600 hover:bg-blue-700 text-white"
