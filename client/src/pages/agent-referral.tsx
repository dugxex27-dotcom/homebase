              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white rounded-lg p-3 space-y-2 border border-gray-200">
                  ...
                  <div className="space-y-1">
                    ...
                    <Button
                      onClick={() => downloadImageWithCode(homeownerInstagramStoryImg, `homebase-homeowner-story-${referralCode}.png`, { x: 300, y: 940 })}
                      size="sm"
                      className="w-full bg-green-600 hover:bg-green-700"
                ...
                <div className="bg-white rounded-lg p-3 space-y-2 border border-gray-200">
                  ...
                  <div className="space-y-1">
                    ...
                    <Button
                      onClick={() => downloadImageWithCode(homeownerFacebookTwitterImg, `homebase-homeowner-facebook-${referralCode}.png`, { x: 840, y: 724 })}
                      size="sm"
                      className="w-full bg-green-600 hover:bg-green-700"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white rounded-lg p-3 space-y-2 border border-gray-200">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-600">Horizontal - 1200x630px</p>
                    <Button
                      onClick={() => downloadImageWithCode(facebookTwitterImg, `homebase-agent-facebook-${referralCode}.png`, { x: 696, y: 772 })}
                      size="sm"
                      className="w-full bg-green-600 hover:bg-green-700"
