    ...
    <div className="min-h-screen" style={{ backgroundColor: '#f5f5f5' }}>
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Share MyHomeBase and earn rewards</p>
        </div>
          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="space-y-4">
              <div className="text-sm text-gray-600">
                Share MyHomeBase with friends and family. Earn rewards when they subscribe!
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Share with friends, family, and neighbors. They get the full MyHomeBase experience while helping you earn rewards!
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white rounded-lg p-3 space-y-2 border border-gray-200">
                  ...
                  <div className="space-y-1">
                    ...
                    <Button
                      onClick={() => downloadImageWithCode(instagramPostImg, `homebase-homeowner-instagram-${referralCode}.png`, { x: 264, y: 782, fontSize: 39, color: '#2c0f5b' })}
                      size="sm"
