          ...
          <CardContent className="prose prose-sm max-w-none mt-6 space-y-6">
            <div>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                The following legal notices apply to all users of the MyHomeBase App ("the App," "we," "us," or "our"). By using MyHomeBase, you agree to the terms outlined below.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                MyHomeBase is a software platform and marketplace that connects homeowners with independent contractors.
              </p>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed font-semibold">
                MyHomeBase is not a contractor, broker, or home services provider.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-2">
                MyHomeBase provides its platform "as is" and makes no warranties, express or implied, regarding:
              </p>
              <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 ml-4 mb-3">
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                The MyHomeBase home maintenance schedule, reminders, and AI-generated suggestions are guidelines only.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-2 font-medium">
                They are:
              </p>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed font-semibold">
                MyHomeBase is not liable for damages resulting from reliance on maintenance suggestions or AI-generated advice.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 ml-4">
                ...
                <li>You will not misuse or rely on MyHomeBase as a replacement for professional advice</li>
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-2">
                To the fullest extent permitted by law, MyHomeBase is not responsible for:
              </p>
              <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 ml-4 mb-3">
