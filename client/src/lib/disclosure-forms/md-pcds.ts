...
export const MD_PCDS_SECTIONS: DisclosureSection[] = [
  {
    id: "general",
  ...
  },
  {
    ...
    questions: [
      { id: "leadPaint", questionNumber: 5, text: "Was the property built before 1978? (Lead paint risk)", type: "yes_no_unknown" },
      { id: "leadPaintTest", questionNumber: 6, text: "Has the property been tested for lead paint?", type: "yes_no_unknown", followUp: "If yes, describe results and whether remediated." },
      ...
      { id: "undergroundTank", questionNumber: 10, text: "Is there a buried oil or chemical storage tank?", type: "yes_no_unknown", followUp: "If yes, describe type, age, and MDE status." },
  ...
  },
  {
    ...
    questions: [
      { id: "heatingType", questionNumber: 18, text: "Primary heating system type", type: "select", options: ["Forced Air Furnace", "Heat Pump", "Boiler / Radiator", "Electric Baseboard", "Radiant Floor", "Other / Unknown"], prefillKey: "hvacType", hint: "From your home profile" },
  ...
  },
  {
    ...
    description: "Legal matters and Maryland-specific disclosures.",
    questions: [
      ...
      { id: "carbonMonoxide", questionNumber: 33, text: "Are carbon monoxide detectors installed as required?", type: "yes_no_unknown" },
...
export function generateMDSummaryText(answers: DisclosureAnswers, propertyAddress?: string): string {
  const lines: string[] = [];
  lines.push("MARYLAND PROPERTY DISCLOSURE AND DISCLAIMER STATEMENT");
  lines.push("=".repeat(55));
  if (propertyAddress) lines.push(`Property Address: ${propertyAddress}`);
  lines.push("");
  for (const section of MD_PCDS_SECTIONS) {
